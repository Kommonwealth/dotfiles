...
workspaces = [
    ...
    {"name": workspace_names[1], "key": "2", "matches": [Match(wm_class="Sublime Text")], "lay": "monadtall"},
    ...
    {"name": workspace_names[5], "key": "6", "matches": [Match(wm_class="")], "lay": "bsp"},
    {"name": workspace_names[6], "key": "7", "matches": [Match(wm_class="Steam")], "lay": "bsp"},
]
